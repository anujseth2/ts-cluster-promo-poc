...
def test_stripping_tiles_keeps_the_rest_of_the_board():
    ...
    # The layout tile goes with it. Keeping it as a visible "something was removed" hole was
    # tried and does not work: ThoughtSpot accepts the orphan and then discards it, so the board
    # closes up regardless (ps-internal 2026-09-23). Sending what the platform will actually keep
    # means the TML we send matches the TML that comes back.
